  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (formData.jumlahTamu > selectedRoom.kapasitas) {
        toast.error(
          `Jumlah tamu melebihi kapasitas kamar (${selectedRoom.kapasitas} orang)`
        );
        return;
      }
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <div className="text-center space-y-2">
        ...
        <p className="text-muted-foreground">Lengkapi data pemesanan Anda</p>
      </div>
              ...
              <Card className="bg-muted/50">
                <CardContent className="p-4 space-y-2">
                  <div className="flex justify-between items-center">
                    ...
                    <span>
                      Rp{" "}
                      {(calculateDays() * selectedRoom.harga).toLocaleString(
                        "id-ID"
                      )}
                    </span>
                  </div>
