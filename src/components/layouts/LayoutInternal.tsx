...
const navigationItems = [
  ...
  },
  {
    title: "Laporan",
    icon: BarChart3,
    children: [{ title: "Okupansi", href: "/dashboard/laporan/okupansi" }],
  },
];
...
export default function LayoutInternal() {
  ...
  const getPageTitle = () => {
    ...
    if (path.includes("operasional/pemesanan"))
      return "Operasional - Pemesanan";
    if (path.includes("operasional/transaksi"))
      return "Operasional - Transaksi";
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <span className="text-sm text-muted-foreground">
                {currentUser?.namaLengkap || currentUser?.nama} (
                {currentUser?.peran || currentUser?.role})
              </span>
